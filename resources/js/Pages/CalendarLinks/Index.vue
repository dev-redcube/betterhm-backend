...
import CalendarLink from "@/Pages/CalendarLinks/CalendarLink.vue";
...
<template>
    ...
    <AuthenticatedLayout>
        <div class="max-w-5xl mx-auto p-4 sm:p-6 lg:p-8">
            <form @submit.prevent="form.post(route('calendarLinks.store'), { onSuccess: () => form.reset() })"
                ...
                <input type="url" v-model="form.url" placeholder="Url"
            ...
            <div class="overflow-x-auto w-full mt-8 dark:text-slate-100">
                <table class="w-full">
                    ...
                    <tbody class="divide-y dark:divide-slate-500">
                        <CalendarLink v-for="link in links" :key="link.id" :link="link" />
                    </tbody>
                </table>
            </div>
